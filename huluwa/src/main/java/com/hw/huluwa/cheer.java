...
public class cheer extends lives {
	...
	public cheer(int x)
	{
		...
		switch(this.no)
		{
		case 0:this.name="爷爷";this.setIn(true);url="src/icon/yeye.png";break;
		case 1:this.name="蛇精";this.setIn(false);url="src/icon/se.png";break;
	...
	public void go()
	{
		//this.setWhere(this.getX(), this.getY()+1);
	}
